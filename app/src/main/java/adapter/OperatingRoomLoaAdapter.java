...
public class OperatingRoomLoaAdapter extends RecyclerView.Adapter<OperatingRoomLoaAdapter.Holder> {
    private Context context;
    ArrayList<MaceRequest.GroupedByCostCenter.GroupedByDiag> arrayListGroupedByDiag = new ArrayList<>();


    public OperatingRoomLoaAdapter(Context context, ArrayList<MaceRequest.GroupedByCostCenter.GroupedByDiag> arrayListGroupedByDiag) {
    ...
    @Override
    public OperatingRoomLoaAdapter.Holder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(Holder holder, int position) {
        ...
        if (!groupedByDiag.getDiagDesc().equalsIgnoreCase(SharedPref.OP_TITLE)) {
            holder.tv_procedure_name.setVisibility(View.VISIBLE);
            holder.tv_processName.setVisibility(View.VISIBLE);
            holder.tv_procedure_name.setText("DIAGNOSIS: ");
        ...
        SharedPref.OP_TITLE = groupedByDiag.getDiagDesc();
