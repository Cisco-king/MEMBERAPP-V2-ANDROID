        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.cv_account:
                    ...
                    intent.putExtra(Constant.BIRTHDAY, header.get(0).getBDAY());
                    ...
                    intent.putExtra(Constant.MEM_STATUS, header.get(0).getMem_OStat_Code());
        ...
        appInterface.getDependentInfo(id)
                ...
                .subscribe(new Subscriber<VerifyMemberData>() {
                    ...
                    public void onNext(VerifyMemberData memberInfo) {
                        ...
                        intent.putExtra(Constant.BIRTHDAY, memberInfo.getMemberInfo().getBDAY());
                        ...
                        intent.putExtra(Constant.MEM_STATUS, memberInfo.getMemberInfo().getMem_OStat_Code() + "");
