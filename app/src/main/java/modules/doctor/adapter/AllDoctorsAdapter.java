...
/**
 * Created by macbookpro on 7/24/17.
 */
...
public class AllDoctorsAdapter extends RecyclerView.Adapter<AllDoctorsAdapter.ViewHolder> {
    ...
    private AllDoctorsAdapter.OnItemClickListener listener;

    public AllDoctorsAdapter(Context context, List<HospitalsToDoctor> doctors, AllDoctorsAdapter.OnItemClickListener listener) {
    ...
    @Override
    public AllDoctorsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_doctor, parent, false);
        return new AllDoctorsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AllDoctorsAdapter.ViewHolder holder, int position) {
    ...
    public HospitalsToDoctor getDoctor(int position) {
